...
import { MOCK_BOOKINGS, MOCK_BOOKING_TRENDS, MOCK_REVENUE_TRENDS } from '@/lib/constants';
  ...
  return (
    <div className="space-y-8 pt-4">
      ...
      >
        ...
        <p className="text-foreground/60 mt-2">Welcome to the administrative panel</p>
      </motion.div>
              ...
              <tbody>
                {MOCK_BOOKINGS.slice(0, 5).map((booking) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-4 text-accent font-semibold">${booking.totalPrice}</td>
                  </motion.tr>
                ))}
              </tbody>
            </table>
